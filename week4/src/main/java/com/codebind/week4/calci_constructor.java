...
public class calci_constructor extends Applet implements ActionListener {
	private static final Logger LOGGER=LogManager.getLogger(calci_constructor.class);
